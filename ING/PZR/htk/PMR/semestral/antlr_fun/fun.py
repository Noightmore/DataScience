...
#from ING.PMR.antlr_fun.CzechParser import CzechParser
...
if __name__ == "__main__":
    ...
    for s in samples2:
         print(f"{s} -> {rewrite_text(s)}")
# info:
# program transformuje grafemy na fonemy v kontextu celeho textu, nutno odstranit mezery,
# pokud chceme foneticky prepis cele vety, pro zanechani pozice mezer nutno si bokem zaznamenat jejich pozice

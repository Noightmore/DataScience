function LTWtrain(fileListPath, referenceFile, K)
    % example usage: LTWtrain('TrainFileListAll.txt', 'LTW_reference_features_all.mat', 16);
    ...
    for i = 1:numFiles
        ...
        % Compute ZCR & Energy (Store full sequence)
        ...
        referenceEnergy{i} = energySeq;
        referenceZCR{i} = zcrSeq;
        referenceSpectral{i} = spectralSeq;
